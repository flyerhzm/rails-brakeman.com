  ...
  context '#notify_build_success' do
    ...
    it {
      is_expected.to have_body_text(
        "<a href=\"http://localhost:3000/flyerhzm/rails-brakeman.com/builds/#{@build.id}\">http://localhost:3000/flyerhzm/rails-brakeman.com/builds/#{@build.id}</a>"
      )
    }
