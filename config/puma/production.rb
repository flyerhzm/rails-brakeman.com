...
stdout_redirect '/home/deploy/sites/rails-brakeman.com/production/current/log/stdout.log',
                '/home/deploy/sites/rails-brakeman.com/production/current/log/stderr.log'
threads 4, 16
workers 2
